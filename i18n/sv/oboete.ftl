...
folder-import = Importera
import-between-term-title = Mellan term & definition
import-between-term-placeholder = Tecken mellan term & definition
import-between-cards-title = Mellan kort
import-between-cards-placeholder = Tecken mellan kort 
import-content-title = Importera innehåll
import-content-placeholder = Innehåll att importera
import-button = Importera
reset-folder-flashcards-title = Återställ status för alla flashkort
reset-folder-flashcards-button = Återställ
import-anki-title = Importera från Anki fil
import-anki-button = Välj Anki fil
